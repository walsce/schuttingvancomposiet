...
Premium merken zoals premium WPC composiet gebruiken een hoger percentage houtvezels en betere polymeren dan budgetmerken. Dit resulteert in een stabieler en duurzamer product.
...
- Premium merken zoals premium WPC composiet (Poolse kwaliteitsproducent)
...
- Prijs-kwaliteitverhouding belangrijk is bij grotere projecten`,
    ...
    comparisonTable: {
      ...
      rows: [
        { aspect: "Merken", option1: "Elephant, Woodvision", option2: "premium WPC composiet, premium composiet" },
...
- Langere garantie belangrijk voor je is`,
    ...
    comparisonTable: {
      ...
      rows: [
        { aspect: "Merken", option1: "Elephant, huismerk", option2: "premium WPC composiet, premium composiet" },
