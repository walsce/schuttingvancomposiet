...
export const blogArticlesExpansion: BlogArticle[] = [
  {
    slug: "kleine-tuin-met-composiet-terras",
    title: "Kleine tuin met composiet terras: 7 slimme ideeën",
    excerpt: "Haal het maximale uit een kleine tuin met een composiet terras. Van niveauverschillen tot multifunctionele vlonders — ontdek slimme ontwerptips.",
    category: "inspiratie",
...
Een kleine tuin vraagt om slimme oplossingen. Composiet vlonderplanken bieden precies dat: een strak, onderhoudsvrij oppervlak dat je buitenruimte visueel vergroot.
...
Een kleine tuin is geen beperking — het is een kans om creatief te zijn.`,
  },
  {
    ...
    title: "Composiet schutting of tuinscherm: wat past bij jou?",
    excerpt: "Twijfel je tussen een composiet schutting en een tuinscherm? Ontdek de verschillen in privacy, uitstraling, montage en prijs.",
    category: "koopgids",
...
Beide opties bieden privacy en erfafscheiding, maar er zijn belangrijke verschillen.
...
| | Composiet schutting | Composiet tuinscherm |
|---|---|---|
| Privacy | ★★★★★ | ★★★☆☆ – ★★★★★ |
...
Combineer beide! Gebruik een dichte composiet schutting aan de straatzijde en sierlijke tuinschermen tussen buren.`,
  },
  {
    ...
    title: "Composiet terras kosten berekenen: compleet overzicht 2026",
    excerpt: "Wat kost een composiet terras? Van materiaal tot arbeidskosten — bereken de totale investering voor jouw droomterras.",
    category: "koopgids",
...
Bereken exact hoeveel materiaal je nodig hebt met onze gratis TerrasDesigner Pro.`,
  },
  {
    ...
    title: "Composiet schutting winterklaar maken: 6 essentiële tips",
    excerpt: "Bereid je composiet schutting voor op de winter met deze onderhoudstips. Voorkom schade door vorst, vocht en storm.",
    category: "onderhoud",
...
Composiet is van nature weerbestendig, maar een paar simpele voorbereidingen zorgen ervoor dat je schutting de winter probleemloos doorkomt.
...
Met minimale voorbereiding gaat je composiet schutting probleemloos de winter door. premium WPC composiet is ontworpen om extreme temperaturen (-20°C tot +60°C) te weerstaan.`,
  },
  {
    ...
    title: "Een duurzame tuin inrichten met composiet materialen",
    excerpt: "Ontdek hoe composiet bijdraagt aan een duurzame tuin. Van recycled materiaal tot lange levensduur — bouw groen met composiet.",
    category: "inspiratie",
...
Duurzaamheid is meer dan een trend — het is een noodzaak. Composiet materialen passen perfect in een milieubewuste tuinfilosofie.
...
|---|---|---|---|
| Composiet | 25+ jaar | Geen | 2× |
| Hardhout | 15–20 jaar | Jaarlijks | 3× |
| Zachthout | 5–10 jaar | Jaarlijks | 5–10× |
...
Met WPC composiet maak je een bewuste keuze voor mens en milieu.`,
  },
  {
    ...
    title: "Composiet vlonder bij het zwembad: do's en don'ts",
    excerpt: "Een composiet vlonder rond het zwembad is ideaal — splintervrij, antislip en chloorbestendig. Ontdek de beste tips voor pooldecks.",
    category: "onderhoud",
...
Een pooldeck moet voldoen aan strenge eisen: antislip, splintervrij, water- en chloorbestendig. Composiet scoort op al deze punten.
...
grijs is de veiligste keuze, maar walnoot en donkerbruin bieden een warmer alternatief.`,
  },
  {
    ...
    title: "Composiet terras verlichting: sfeer creëren met LED",
    excerpt: "Verleng je terrasavonden met de juiste verlichting. Ontdek hoe je LED integreert in je composiet vlonder voor maximale sfeer.",
    category: "inspiratie",
    image: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&q=80",
    readTime: 5,
    date: "2026-01-25",
...
| Type | IP-rating | Verbruik | Levensduur |
|---|---|---|---|
| Inbouw spots | IP67 | 0,5–1W per spot | 50.000 uur |
...
| Component | Kosten |
|---|---|
| 10 inbouw spots + trafo | €120–€200 |
| 5 meter LED-strip | €40–€80 |
| Professionele installatie | €200–€400 |
| **Totaal (gemiddeld terras)** | **€350–€650** |
