...
const shapes: { id: PresetShape; label: string; svg: string }[] = [
  ...
  },
  {
    id: "l-shape-left",
    label: "L links",
    svg: "M2,2 L18,2 L18,14 L10,14 L10,8 L2,8 Z",
  },
  {
    id: "l-shape-bottom-right",
    label: "L onder-R",
    svg: "M2,2 L10,2 L10,8 L18,8 L18,14 L2,14 Z",
  },
  {
    id: "l-shape-bottom-left",
    label: "L onder-L",
    svg: "M10,2 L18,2 L18,14 L2,14 L2,8 L10,8 Z",
  },
  {
    id: "u-shape",
    label: "U-vorm",
  ...
  },
  {
    id: "t-shape",
    label: "T-vorm",
    svg: "M2,2 L18,2 L18,7 L13,7 L13,14 L7,14 L7,7 L2,7 Z",
  },
  {
    id: "circle",
    label: "Cirkel",
    svg: "M10,2 L14,3 L17,6 L18,10 L17,13 L14,15 L10,16 L6,15 L3,13 L2,10 L3,6 L6,3 Z",
  },
];
  ...
  return (
    <div className="grid grid-cols-4 gap-2">
      {shapes.map((s) => (
        ...
        >
          <svg viewBox="0 0 20 18" className="w-10 h-8">
            <path
              d={s.svg}
