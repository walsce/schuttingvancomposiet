...
const ProductPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background" style={{ zoom: typeof window !== 'undefined' && window.innerWidth >= 640 ? 0.9 : 1 }}>
      <SEOHead
